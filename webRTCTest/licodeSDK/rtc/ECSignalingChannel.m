...
- (void)connect {
    ...
    NSString *hostURLString = @"54.218.81.29:8080";
    ...
    if (![urlTest evaluateWithObject:hostURLString]){
        ...
        //hostURLString = [NSString stringWithFormat:@"https://%@", hostURLString];    // prepand dummy http protocol to make sure NSURL is working
    }
